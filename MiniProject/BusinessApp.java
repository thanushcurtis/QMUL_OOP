...
public class BusinessApp extends JFrame implements GenericMethods {
    ...
    public BusinessApp(){
        ...
        int user_input=0;
        try{
            user_input = GenericMethods.input_int("Press 1 to run the app text based.."+"\n"+"Press 2 to run the app GUI Based"+"\n");
            while(user_input!=1 && user_input!=2)
            {
                user_input=GenericMethods.input_int(("Please enter an integer 1 or 2"));
            }
        }
        catch(NumberFormatException ex)
        {
